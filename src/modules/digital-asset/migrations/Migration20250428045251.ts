...
export class Migration20250428045251 extends Migration {
  ...
  override async down(): Promise<void> {
    this.addSql(`alter table if exists "digital_asset_license" drop constraint if exists "digital_asset_license_digital_asset_id_id_foreign";`);
